...
<table border="1" style="width: 100%; border-collapse: collapse;">
    <caption>Data analysis libraries in Python.</caption>
    <tr>
    ...
    <tr>
        <td rowspan="5">Data Analysis</td>
        <td>NumPy</td>
        <td>Numerical computing library for efficient array operations</td>
    ...
    <tr>
        <td>SciPy</td>
        <td>Scientific computing library for advanced mathematical functions and algorithms</td>
        <td><a href="https://www.scipy.org">SciPy</a></td>
    </tr>
    <tr>
        <td>scikit-learn</td>
        <td>Machine learning library with various algorithms and utilities</td>
        <td><a href="https://scikit-learn.org">scikit-learn</a></td>
    </tr>
    <tr>
        <td>statsmodels</td>
        <td>Statistical modeling and testing library</td>
...
<table border="1" style="width: 100%; border-collapse: collapse;">
    <caption>Data visualization libraries in Python.</caption>
    <tr>
        <th style="width: 15%;">Purpose</th>
        <th style="width: 15%;">Library</th>
        <th style="width: 55%;">Description</th>
    ...
    <tr>
        <td rowspan="5">Visualization</td>
        <td>Matplotlib</td>
        <td>Matplotlib is a Python library for creating various types of data visualizations, such as charts and graphs</td>
        <td><a href="https://matplotlib.org">Matplotlib</a></td>
    </tr>
    <tr>
        <td>Seaborn</td>
        <td>Statistical data visualization library</td>
    ...
    <tr>
        <td>ggplot2</td>
        <td>Grammar of Graphics-based plotting system (Python via <code>plotnine</code>)</td>
        <td><a href="https://ggplot2.tidyverse.org">ggplot2</a></td>
    </tr>
    <tr>
        <td>Altair</td>
        <td>Altair is a Python library for declarative data visualization. It provides a simple and intuitive API for creating interactive and informative charts from data</td>
...
<table border="1" style="width: 100%; border-collapse: collapse;">
    <caption>Deep learning frameworks in Python.</caption>
    <tr>
        <th style="width: 15%;">Purpose</th>
        <th style="width: 15%;">Library</th>
        <th style="width: 55%;">Description</th>
    ...
    <tr>
        ...
        <td>TensorFlow</td>
        <td>Open-source deep learning framework</td>
        <td><a href="https://www.tensorflow.org">TensorFlow</a></td>
    </tr>
    <tr>
        <td>Keras</td>
        <td>High-level neural networks API (works with TensorFlow)</td>
        <td><a href="https://keras.io">Keras</a></td>
    </tr>
    <tr>
        <td>PyTorch</td>
        <td>Deep learning framework with dynamic computational graphs</td>
...
<table border="1" style="width: 100%; border-collapse: collapse;">
    <caption>Database libraries in Python.</caption>
    <tr>
        <th style="width: 15%;">Purpose</th>
        <th style="width: 15%;">Library</th>
        <th style="width: 55%;">Description</th>
    ...
    <tr>
        ...
        <td>SQLAlchemy</td>
        <td>SQL toolkit and Object-Relational Mapping (ORM) library</td>
        <td><a href="https://www.sqlalchemy.org">SQLAlchemy</a></td>
    </tr>
    <tr>
        <td>PyMySQL</td>
        <td>Pure-Python MySQL client library</td>
        <td><a href="https://pymysql.readthedocs.io">PyMySQL</a></td>
    </tr>
    <tr>
        <td>psycopg2</td>
    ...
    <tr>
        <td>SQLite3</td>
        <td>Python's built-in SQLite3 module</td>
        <td><a href="https://docs.python.org/3/library/sqlite3.html">SQLite3</a></td>
    </tr>
    <tr>
        <td>DuckDB</td>
        <td>DuckDB is a high-performance, in-memory database engine designed for interactive data analytics</td>
...
<table border="1" style="width: 100%; border-collapse: collapse;">
    <caption>Workflow and task automation libraries in Python.</caption>
    <tr>
        <th style="width: 15%;">Purpose</th>
        <th style="width: 15%;">Library</th>
        <th style="width: 55%;">Description</th>
    ...
    <tr>
        <td rowspan="4">Workflow</td>
        <td>Jupyter Notebook</td>
        <td>Interactive and collaborative coding environment</td>
        <td><a href="https://jupyter.org">Jupyter</a></td>
    </tr>
    <tr>
    ...
    <tr>
        <td>Luigi</td>
        <td>Python package for building complex pipelines of batch jobs</td>
        <td><a href="https://luigi.readthedocs.io">Luigi</a></td>
    </tr>
    <tr>
        <td>Dask</td>
        <td>Parallel computing library for scaling Python workflows</td>
...
<table border="1" style="width: 100%; border-collapse: collapse;">
    <caption>Version control and repository hosting services.</caption>
    <tr>
        <th style="width: 15%;">Purpose</th>
        <th style="width: 15%;">Library</th>
        <th style="width: 55%;">Description</th>
    ...
    <tr>
        <td rowspan="3">Version Control</td>
        <td>Git</td>
    ...
    <tr>
        <td>GitLab</td>
        <td>Web-based Git repository management and CI/CD platform</td>
